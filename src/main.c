...
/*   Updated: 2024/11/22 09:22:35 by benhajdahma      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	mlx_data_init(t_mlx_data *data)
{
	...
	if (!data->mlx_connection)
		return (0);
	data->mlx_window = mlx_new_window(data->mlx_connection, data->width,
			data->height, "miniRT");
	if (!data->mlx_window)
	{
	...
	data->image.img_ptr = mlx_new_image(data->mlx_connection, data->width,
			data->height);
